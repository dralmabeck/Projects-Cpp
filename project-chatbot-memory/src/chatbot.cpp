...
ChatBot::ChatBot(std::string filename)
{
    ...
    // CHANGE TASK 2: Change output string 
    std::cout << "ChatBot STANDARD Constructor" << std::endl;
...
ChatBot::~ChatBot()
{
    std::cout << "ChatBot STANDARD Destructor" << std::endl;
...
// CHANGE TASK 2: constructor COPY
...
// CHANGE TASK 2: constructor MOVE
...
// CHANGE TASK 2: constructor COPY ASSIGNMENT
...
// CHANGE TASK 2: constructor MOVE Assignment
ChatBot &ChatBot::operator=(ChatBot &&other) // Constructor MOVE Assignment
{
