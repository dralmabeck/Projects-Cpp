...
void Intersection::addVehicleToQueue(std::shared_ptr<Vehicle> vehicle)
{
    ...
    if(!trafficLightIsGreen()) // FP.6
    {
        _trafficLight.waitForGreen(); // FP.6
    }
...
bool Intersection::trafficLightIsGreen()
{
   ...
   if (_trafficLight.getCurrentPhase() == TrafficLightPhase::green) // FP.does_not_work_otherwise
       return true; // FP.does_not_work_otherwise
   else
       return false; // FP.does_not_work_otherwise
